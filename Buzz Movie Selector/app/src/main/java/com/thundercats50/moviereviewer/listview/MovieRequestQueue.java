...
public class MovieRequestQueue {
    ...
    private static MovieRequestQueue mInstance;
    ...
    private MovieRequestQueue(Context context) {
        ...
        // Use the custom made bitmap cache class so delete the commented out sections
    ...
    */
    ...
    public static synchronized MovieRequestQueue getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new MovieRequestQueue(context);
        }
        return mInstance;
    }
